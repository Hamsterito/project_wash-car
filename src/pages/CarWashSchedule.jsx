  ...
  const CarWashSchedule = () => {
    ...
    return (
      <div className="schedule-container">
        <h1 className="schedule-title"> Расписание автомойки </h1>
                    ...
                    .map((booking, index) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td id="totalPrice">{formattedBooking.totalPrice} Тг</td>
                          <td className="center_align_text">{formattedBooking.duration} мин</td>
          ...
          <>
                  ...
                  <tbody>
                    {todaySchedule.map((entry, index) => (
                      <tr key={index}>
                        ...
                        <td className="center_align_text">{entry.duration} мин</td>
            ...
            <div className="schedule-section" style={{ marginTop: "50px" }}>
              ...
              {tomorrowSchedule.length > 0 ? (
                <table className="schedule-table" id="all_book_table">
                  <thead>
                    <tr>
                      <th>ФИО</th>
                      <th>Машина</th>
